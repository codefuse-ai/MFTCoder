...
def build_train_valid_test_datasets(
    ...
    # assert os.path.exists(data_prefix + "_loss_mask.bin"), f"loss_mask mask datafile not found: {data_prefix}_loss_mask.bin"
...
def build_datasets(args):
    ...
    valid_iters = (train_iters // args.valid_interval + 1) * args.valid_iters
